...
import net.kno3.season.roverruckus.solus.robot.acmedrive.SampleTankDriveREV;
...
public class DriveSystem extends SubSystem{
    ...
    public void init() {
        ...
        /*DcMotor frontLeft = hardwareMap().dcMotor.get(Solus.DRIVE_FL_KEY);
        DcMotor rearLeft = hardwareMap().dcMotor.get(Solus.DRIVE_RL_KEY);
        DcMotor frontRight = hardwareMap().dcMotor.get(Solus.DRIVE_FR_KEY);
        DcMotor rearRight = hardwareMap().dcMotor.get(Solus.DRIVE_RR_KEY);*/
        DcMotor frontLeft = hardwareMap().get(DcMotorEx.class, Solus.DRIVE_FL_KEY);
        DcMotor rearLeft = hardwareMap().get(DcMotorEx.class, Solus.DRIVE_RL_KEY);
        DcMotor frontRight = hardwareMap().get(DcMotorEx.class, Solus.DRIVE_FR_KEY);
        DcMotor rearRight = hardwareMap().get(DcMotorEx.class, Solus.DRIVE_RR_KEY);
        ...
        Threading.startThread(() -> {
            try {
                ...
                imu = new SafeAdafruitIMU(hardwareMap(), Solus.IMU_KEY, true);
                imu.update();
                imu.zeroHeading();
    ...
    public void turnPID(double angle) {
        turnPID(kTurnPID_maxTurn, kTurnPID_p, kTurnPID_i, kTurnPID_d, angle, 2, 0.02);
    }
