...
import net.kno3.season.roverruckus.solus.robot.acmedrive.LynxOptimizedI2cFactory;
...
public class SampleTankDriveREVOptimized extends SampleTankDriveBase {
    ...
    public SampleTankDriveREVOptimized(HardwareMap hardwareMap) {
        ...
        ExpansionHubMotor leftFront = hardwareMap.get(ExpansionHubMotor.class, "frontleft");
        ExpansionHubMotor leftRear = hardwareMap.get(ExpansionHubMotor.class, "rearleft");
        ExpansionHubMotor rightRear = hardwareMap.get(ExpansionHubMotor.class, "rearright");
        ExpansionHubMotor rightFront = hardwareMap.get(ExpansionHubMotor.class, "frontright");
