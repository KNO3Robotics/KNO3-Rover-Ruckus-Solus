package net.kno3.season.roverruckus.solus.program.auto.silverside;
...
import static net.kno3.season.roverruckus.solus.robot.HopperSystem.FlipperPosition.IDLE;
import static net.kno3.season.roverruckus.solus.robot.HopperSystem.FlipperPosition.SILVER;

@Autonomous(name = "SOLUS SILVER AUTO 2 Gold", group = "Auto")
public class SilverAuto2G extends SolusAuto {
