package net.kno3.season.roverruckus.solus.program.auto.goldside;
...
@Autonomous(name = "SOLUS GOLD AUTO", group = "Auto")
public class GoldAuto extends SolusAuto {
    ...
    public void main(){
        ...
        intake.intakeSlides.setTargetPosition(intake.getIntakeSlideEncoder()-800);
        intake.intakeSlides.setPower(.7);
        waitFor(1);
