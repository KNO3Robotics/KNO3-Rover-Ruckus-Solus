...
public class KNO3Vision {
    ...
    private CroppingGoldDetector detector;



    public KNO3Vision(OpMode opMode, String cameraName) {
        this.opMode = opMode;

        webcamName = opMode.hardwareMap.get(WebcamName.class, cameraName);
        ...
        detector = new CroppingGoldDetector();
    ...
    public CroppingGoldDetector getDetector() {
        return detector;
    }
    ...
    public Pose3d getPose() {
        ...
        if (targetVisible) {
            ...
            Position position = new Position(DistanceUnit.INCH, translation.get(0) / mmPerInch,
                    translation.get(1) / mmPerInch, translation.get(2) / mmPerInch, 0);

            lastPose = new Pose3d(position, rotation);
            return lastPose;
        ...
        new Thread() {
            ...
            public void run() {
                try {
                    ...
                    Log.e("KNO3", "Failed in camera shutdown", th);
                }
                Log.d("KNO3", "Finished shutting down camera.");
            }
        }.start();
    }
